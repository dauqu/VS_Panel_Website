  ...
  return (
    <div className="">
        <div className="imagecontiner mt-12">
            <img src={back} style={{position:"relative",top:"-200px",margin:"auto",borderRadius:'8px'}} alt="" />
        </div>
        ...
        <div className="lg:w-1/2 w-full my-5 lg:my-0 " >
          ...
          <div className="mt-4 md:flex items-center   justify-around   ">
            ...
            <div className="bg-[#F3E8FF] flex p-6 w-[300px] m-auto my-5 md:my-0 justify-around items-center cursor-pointer hover:shadow-lg">
              <div className="  p-2">
                <FaGooglePlay style={{ color: "#831FFE", fontSize: "45px" }} />
              </div>
              <div className="">
                <div className="text-[#7E7C7C] text-[17px] font-semibold">
                  Get it on{" "}
          ...
          <div className="mt-6 md:flex justify-around ">
            <div className="bg-[#E8FAF4] flex p-6 w-[300px] justify-around  m-auto my-5 md:my-0 items-center cursor-pointer hover:shadow-lg">
              ...
              <div className="">
                ...
                <div className="text-[#333333] text-[25px] font-bold"> Mac</div>
              </div>
            </div>
      ...
      <div className="bg-[#FAFAFA] p-3 xl:p-8">
        ...
        <div className="flex flex-col md:flex-row mt-8 p-8 items-center   m-auto  justify-evenly">
          <div className="card flex bg-[#FFFFFF] p-6 w-[350px] shadow-lg my-5 md:my-0">
            <div className="w-[20%]  ">
              <AiFillBulb style={{ color: "#F9A901", fontSize: "40px" ,background:"#FEF7E6",padding:"4px"   }} />
            </div>
            <div className="ml-4">
              <div className="text-[#5C5C5C] text-[20px] font-bold">Creative Design</div>
              <div className="text-[#808080]">
                Lorem ipsum dolor sit tus obcaecati reiciendis laborum?
              </div>    
              <div className="mt-4">
                <button className="bg-[#FFFFFF] p-2 text-[#6A6A6A] hover:bg-[#165461] hover:text-white" style={{border:"1px solid #808080"}}>Learn More</button>
              </div>
            </div>
          </div>
          <div className="card flex bg-[#FFFFFF] p-6 w-[350px] shadow-lg my-5 md:my-0">
            <div className="w-[20%]  ">
              <FaMobile style={{ color: "#48CB8A", fontSize: "40px" ,background:"#E8FAF4",padding:"4px"   }} />
            </div>
            <div className="ml-4">
              <div className="text-[#5C5C5C] text-[20px] font-bold">Fully Responsive</div>
              <div className="text-[#808080]">
                Lorem ipsum dolor sit tus obcaecati reiciendis laborum?
              </div>    
              <div className="mt-4">
          ...
          <div className="card flex bg-[#FFFFFF] p-6 w-[350px] shadow-lg my-5 md:my-0">
            <div className="w-[20%]  ">
              <FaEdit style={{ color: "#831FFE", fontSize: "40px" ,background:"#F3E8FF",padding:"4px"   }} />
            </div>
            <div className="ml-4">
              <div className="text-[#5C5C5C] text-[20px] font-bold">Creative Design</div>
              <div className="text-[#808080]">
        ...
        <div className="flex flex-col md:flex-row mt-8 p-8 items-center   m-auto  justify-evenly">
          <div className="card flex bg-[#FFFFFF] p-6 w-[350px] shadow-lg my-5 md:my-0">
            <div className="w-[20%]  ">
              <FaDatabase style={{ color: "#F78F71", fontSize: "40px" ,background:"#FEF4F1",padding:"4px"   }} />
            </div>
            <div className="ml-4">
              <div className="text-[#5C5C5C] text-[20px] font-bold">Server Solutions</div>
              <div className="text-[#808080]">
                Lorem ipsum dolor sit tus obcaecati reiciendis laborum?
              </div>    
              <div className="mt-4">
          ...
          <div className="card flex bg-[#FFFFFF] p-6 w-[350px] shadow-lg my-5 md:my-0">
            <div className="w-[20%]  ">
              <BiLink style={{ color: "#165461", fontSize: "40px" ,background:"#E6EEF0",padding:"4px"   }} />
            </div>
            <div className="ml-4">
              <div className="text-[#5C5C5C] text-[20px] font-bold">Quick Link</div>
              <div className="text-[#808080]">
                Lorem ipsum dolor sit tus obcaecati reiciendis laborum?
              </div>    
              <div className="mt-4">
          ...
          <div className="card flex bg-[#FFFFFF] p-6 w-[350px] shadow-lg my-5 md:my-0">
            <div className="w-[20%]  ">
              <BsFillFileEarmarkCodeFill style={{ color: "#1D86FF", fontSize: "40px" ,background:"#E6F3FF",padding:"4px"   }} />
            </div>
            <div className="ml-4">
              <div className="text-[#5C5C5C] text-[20px] font-bold">Well Documented</div>
              <div className="text-[#808080]">
                Lorem ipsum dolor sit tus obcaecati reiciendis laborum?
              </div>    
              <div className="mt-4">
      ...
      <div className="items-center flex justify-center">
        ...
        <div className="flex flex-col md:flex-row  items-center   m-auto justify-around">
            <div className="cardd shadow-md border w-[310px] mt-8 p-6 bg-[#FFFFFF] text-center  hover:scale-110 hover:transition-all">
                ...
                <div  ><span className="text[#222222] font-bold text-[40px] mt-4 ">$25</span>/year</div>
                <hr className="mt-4"/>
                <div className="text-[#383838] font-semibold mt-6">1 Landing Page</div>
                <div className="text-[#383838] font-semibold mt-6">10 Illustration</div>
                <div className="text-[#383838] font-semibold mt-6">10 Template</div>
                <div className="text-[#383838] font-semibold mt-6">3d Icon</div>
                <div className="text-[#383838] font-semibold mt-6">10 Photo Assets</div>
                <div className="mt-8">
                 <button className="p-2 font-semibold text-[#26606B] hover:bg-[#165461] hover:text-white " style={{border:"1px solid #215E6A",  }}>Buy Package</button>
                </div>
            </div>
            <div className="cardd shadow-md border w-[310px] mt-8 p-6 bg-[#FFFFFF] text-center  hover:scale-110 hover:transition-all">
                <div className="text-[#22616C] font-semibold mt-4">Standard</div>
                <div  ><span className="text[#222222] font-bold text-[40px] mt-4 ">$50</span>/year</div>
                <hr className="mt-4"/>
                <div className="text-[#383838] font-semibold mt-6">1 Landing Page</div>
                <div className="text-[#383838] font-semibold mt-6">10 Illustration</div>
                <div className="text-[#383838] font-semibold mt-6">10 Template</div>
            ...
            <div className="cardd shadow-md border w-[310px] mt-8 p-6 bg-[#FFFFFF] text-center  hover:scale-110 hover:transition-all">
                ...
                <div  ><span className="text[#222222] font-bold text-[40px] mt-4 ">$75</span>/year</div>
                <hr className="mt-4"/>
                <div className="text-[#383838] font-semibold mt-6">1 Landing Page</div>
                <div className="text-[#383838] font-semibold mt-6">10 Illustration</div>
                <div className="text-[#383838] font-semibold mt-6">10 Template</div>
            ...
            <div className="cardd shadow-md border w-[310px] mt-8 p-6 bg-[#FFFFFF] text-center  hover:scale-110 hover:transition-all">
                ...
                <div  ><span className="text[#222222] font-bold text-[40px] mt-4 ">$100</span>/year</div>
                <hr className="mt-4"/>
                <div className="text-[#383838] font-semibold mt-6">1 Landing Page</div>
                <div className="text-[#383838] font-semibold mt-6">10 Illustration</div>
                <div className="text-[#383838] font-semibold mt-6">10 Template</div>
      ...
      <div className="items-center flex justify-center">
        ...
        <div className="flex flex-col md:flex-row  items-center   m-auto  justify-around  p-4  ">
            <div className="md:w-1/2 sm:flex p-2 bg-[#FFFFFF] shadow-md m-auto my-5 md:my-0 ">
                <div className="w-full"><img src={user} className="min-w-[60px] max-w-[160px] m-auto"  alt="" /></div>
                <div className="">
                    <div className="text-[#333333] text-[30px] font-semibold">Sean Harvey</div>
                    <div className="text-[#8B8B8B] text-[15px] font-semibold">Founder & CEO</div>
                    <div className="flex mt-2">
                        <div className="text-[#165461]"><AiFillStar style={{fontSize:"22px"}}/></div>
                        <div className="text-[#165461]"><AiFillStar style={{fontSize:"22px"}}/></div>
                        <div className="text-[#165461]"><AiFillStar style={{fontSize:"22px"}}/></div>
                        <div className="text-[#165461]"><AiFillStar style={{fontSize:"22px"}}/></div>
                        <div className="text-[#165461]"><AiFillStar style={{fontSize:"22px"}}/></div>
                    ...
                    <div className="text-[#898989] text-[15px]  text-justify font-semibold mt-4 ">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sed qui repellat excepturi nostrum doloribus quam nobis, tenetur earum quibusdam! Ad iusto suscipit explicabo non minima similique distinctio veniam, obcaecati magni!</div>
                </div>
            </div>
            <div className="md:w-1/2   sm:flex p-2 bg-[#FFFFFF] shadow-md  m-auto my-5 md:my-0">
                <div className="w-full"><img src={user2} className="min-w-[60px] max-w-[160px] m-auto"  alt="" /></div>
                <div className="">
                    <div className="text-[#333333] text-[30px] font-semibold">Hope Spencer</div>
                    <div className="text-[#8B8B8B] text-[15px] font-semibold">Founder & CEO</div>
                    <div className="flex mt-2">
                        <div className="text-[#165461]"><AiFillStar style={{fontSize:"22px"}}/></div>
                        <div className="text-[#165461]"><AiFillStar style={{fontSize:"22px"}}/></div>
